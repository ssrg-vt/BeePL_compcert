...
Module Info.
  ...
  Definition source_file := "compiler_test/funptr.c".
...
Definition _fun : ident := $"fun".
Definition _fun_ptr : ident := $"fun_ptr".
...
(Scall None
  ...
  ((Evar ___stringlit_1 (tarray tschar 18)) :: (Etempvar _a tint) :: nil))
|}.
...
(Ssequence
  (Ssequence
    (Sset _fun_ptr
      (Eaddrof (Evar _fun (Tfunction (Tcons tint Tnil) tvoid cc_default))
        (tptr (Tfunction (Tcons tint Tnil) tvoid cc_default))))
    (Ssequence
      (Scall None (Evar _fun (Tfunction (Tcons tint Tnil) tvoid cc_default))
        ((Econst_int (Int.repr 15) tint) :: nil))
      (Ssequence
        (Scall None
          (Ederef
            (Etempvar _fun_ptr (tptr (Tfunction (Tcons tint Tnil) tvoid
                                       cc_default)))
            (Tfunction (Tcons tint Tnil) tvoid cc_default))
...
((___compcert_va_int32,
 ...
 (_printf,
   Gfun(External (EF_external "printf"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_fun, Gfun(Internal f_fun)) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _fun :: _printf :: ___builtin_debug :: ___builtin_fmin ::
