...
Module Info.
  ...
  Definition source_file := "compiler_test/struct_ex1.c".
End Info.
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 80) :: Init_int8 (Int.repr 111) ::
                Init_int8 (Int.repr 105) :: Init_int8 (Int.repr 110) ::
                Init_int8 (Int.repr 116) :: Init_int8 (Int.repr 32) ::
                Init_int8 (Int.repr 112) :: Init_int8 (Int.repr 49) ::
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := ((_p1, (Tstruct _Point noattr)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sdo (Eassign
           (Efield
             (Evalof (Evar _p1 (Tstruct _Point noattr))
               (Tstruct _Point noattr)) _x tint)
           (Eval (Vint (Int.repr 10)) tint) tint))
    (Ssequence
      (Sdo (Eassign
             (Efield
               (Evalof (Evar _p1 (Tstruct _Point noattr))
                 (Tstruct _Point noattr)) _y tint)
             (Eval (Vint (Int.repr 20)) tint) tint))
      (Ssequence
        (Sdo (Ecall
               (Evalof
                 ...
                 (Tfunction (Tcons (tptr tschar) Tnil) tint
                   {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
               (Econs
                 (Evalof (Evar ___stringlit_1 (tarray tschar 25))
                   (tarray tschar 25))
                 (Econs
                   (Evalof
                     (Efield
                       (Evalof (Evar _p1 (Tstruct _Point noattr))
                         (Tstruct _Point noattr)) _x tint) tint)
                   (Econs
                     (Evalof
                       (Efield
                         (Evalof (Evar _p1 (Tstruct _Point noattr))
                           (Tstruct _Point noattr)) _y tint) tint) Enil)))
               tint))
