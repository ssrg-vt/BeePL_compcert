...
Definition example1 : BeePL.program := @mkbprogram BeePL_bpf_safe_null_check.bcomposites 
                                                   BeePL_bpf_safe_null_check.global_definitions 
                                                   BeePL_bpf_safe_null_check.public_idents 
                                                   BeePL_bpf_safe_null_check._hash_map_example 
                                                   BeePL_bpf_safe_null_check.bcomposite_correct
                                                   BeePL_bpf_safe_null_check.ident_to_string.
