...
Module Info.
  ...
  Definition source_file := "compiler_test/c_progs/bitstring.c".
End Info.
...
Definition _char_array : ident := $"char_array".
...
Definition _ptr_end : ident := $"ptr_end".
Definition _src : ident := $"src".

Definition v___stringlit_5 := {|
  gvar_info := (tarray tschar 9);
  gvar_init := (Init_int8 (Int.repr 100) :: Init_int8 (Int.repr 115) ::
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 115) :: Init_int8 (Int.repr 114) ::
                Init_int8 (Int.repr 99) :: Init_int8 (Int.repr 58) ::
                Init_int8 (Int.repr 32) :: Init_int8 (Int.repr 37) ::
...
Definition v___stringlit_6 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 107) :: Init_int8 (Int.repr 105) ::
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := ((_src, tint) :: (_dst, tint) :: (_kind, tint) ::
              (_char_array, (tarray tschar 20)) :: (_ptr, (tptr tschar)) ::
              (_ptr_end, (tptr tschar)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sdo (Eassign (Evar _src tint) (Eval (Vint (Int.repr 4)) tint) tint))
    (Ssequence
      (Sdo (Eassign (Evar _dst tint) (Eval (Vint (Int.repr 5)) tint) tint))
      (Ssequence
        (Sdo (Eassign (Evar _kind tint) (Eval (Vint (Int.repr 3)) tint) tint))
        (Ssequence
          (Sdo (Ecall
                 (Evalof
                   ...
                   (Tfunction
                     ...
                     cc_default))
                 (Econs
                   (Evalof (Evar _char_array (tarray tschar 20))
                     (tarray tschar 20))
                   (Econs (Eaddrof (Evar _src tint) (tptr tint))
                     (Econs (Esizeof tint tulong) Enil))) (tptr tvoid)))
          (Ssequence
            (Sdo (Ecall
                   (Evalof
                     (Evar _memcpy (Tfunction
                   ...
                   (Econs
                     (Ebinop Oadd
                       (Evalof (Evar _char_array (tarray tschar 20))
                         (tarray tschar 20)) (Esizeof tint tulong)
                       (tptr tschar))
                     (Econs (Eaddrof (Evar _dst tint) (tptr tint))
                       (Econs (Esizeof tint tulong) Enil))) (tptr tvoid)))
            (Ssequence
              (Sdo (Ecall
                     (Evalof
                     ...
                     (Econs
                       (Ebinop Oadd
                         ...
                         (Ebinop Omul (Esizeof tint tulong)
                           (Eval (Vint (Int.repr 2)) tint) tulong)
                         (tptr tschar))
                       (Econs (Eaddrof (Evar _kind tint) (tptr tint))
                         (Econs (Esizeof tint tulong) Enil))) (tptr tvoid)))
              (Ssequence
                (Sdo (Eassign (Evar _ptr (tptr tschar))
                       (Evalof (Evar _char_array (tarray tschar 20))
                         (tarray tschar 20)) (tptr tschar)))
                (Ssequence
                  (Sdo (Eassign (Evar _ptr_end (tptr tschar))
                         (Ebinop Oadd
                           (Evalof (Evar _char_array (tarray tschar 20))
                             (tarray tschar 20))
                           (Esizeof (tarray tschar 20) tulong) (tptr tschar))
                         (tptr tschar)))
                  (Ssequence
                    (Sifthenelse (Ebinop Ogt
                                   (Ebinop Oadd
                                     (Evalof (Evar _ptr (tptr tschar))
                                       (tptr tschar)) (Esizeof tint tulong)
                                     (tptr tschar))
                                   (Evalof (Evar _ptr_end (tptr tschar))
                                     (tptr tschar)) tint)
                                     ...
                                     (Evalof
                                       (Ederef
                                         (Ebinop Oadd
                                           (Ecast
                                             (Evalof
                                               (Evar _ptr (tptr tschar))
                                               (tptr tschar)) (tptr tint))
                                           (Eval (Vint (Int.repr 1)) tint)
                                           (tptr tint)) tint) tint) Enil))
                                 tint))
                          (Ssequence
                            (Sifthenelse (Ebinop Ogt
                                           (Ebinop Oadd
                                             ...
                                             (Ebinop Omul
                                               (Esizeof tint tulong)
                                               (Eval (Vint (Int.repr 3)) tint)
                                               tulong) (tptr tschar))
                                           (Evalof
                                             (Evar _ptr_end (tptr tschar))
                                             (tptr tschar)) tint)
                              (Sreturn (Some (Eunop Oneg
                                               (Eval (Vint (Int.repr 3)) tint)
                                               tint)))
                            ...
                            (Ssequence
                              (Sdo (Ecall
                                     ...
                                     (Econs
                                       (Evalof
                                         (Evar ___stringlit_3 (tarray tschar 10))
                                         (tarray tschar 10))
                                       (Econs
                                         (Evalof
                                           (Ederef
                              ...
                              (Ssequence
                                (Sdo (Ecall
                                       ...
                                       (Econs
                                         (Evalof
                                           (Evar ___stringlit_4 (tarray tschar 32))
                                           (tarray tschar 32))
                                         (Econs
                                           (Ecast
                                             (Evalof
                                           ...
                                           (Econs
                                             (Evalof
                                               (Evar _char_array (tarray tschar 20))
                                               (tarray tschar 20)) Enil)))
                                       tint))
                                (Ssequence
                                  (Sdo (Ecall
                                         (Evalof
...
((___compcert_va_int32,
 ...
 (_memcpy,
   Gfun(External (EF_external "memcpy"
     ...
     (tptr tvoid) cc_default)) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _memcpy :: _printf :: ___builtin_debug :: ___builtin_fmin ::
