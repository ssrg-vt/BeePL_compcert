Require Import Integers AST Ctypes BeePL BeeTypes BeePL_values BeePL_typechecker BeePL_notations BeePL_bpf BeePL_helper_functions. 
...
Definition global_definitions : list (ident * AST.globdef BeePL.fundef type * option string) 
   := (_val, Gvar v_val, None) :: 
      ...
      (_xdp_packet_count, AST.Gfun(BeePL.Internal (f_xdp_packet_count)), Some "foo") :: nil.
...
Compute (type_check_program example1). *) (* Type checks fails! Expected as the section attribute should be "xdp", not "foo" *)
