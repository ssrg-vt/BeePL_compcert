...
Module Info.
  ...
  Definition source_file := "compiler_test/for_ex1.c".
End Info.
...
(Ssequence
  (Ssequence
    (Ssequence
      (Sdo (Eassign (Evar _i tint) (Eval (Vint (Int.repr 5)) tint) tint))
      (Sfor
        Sskip
        (Ebinop Oge (Evalof (Evar _i tint) tint)
          (Eval (Vint (Int.repr 1)) tint) tint)
        (Sdo (Epostincr Decr (Evar _i tint) tint))
        (Sdo (Ecall
               (Evalof
               ...
               (Econs
                 (Evalof (Evar ___stringlit_1 (tarray tschar 12))
                   (tarray tschar 12))
                 (Econs (Evalof (Evar _i tint) tint) Enil)) tint))))
