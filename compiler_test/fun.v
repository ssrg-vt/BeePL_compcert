...
Module Info.
  ...
  Definition source_file := "compiler_test/fun.c".
...
Definition f_add := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ebinop Oadd (Etempvar _x tint) (Etempvar _y tint) tint)))
|}.
...
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _add (Tfunction (Tcons tint (Tcons tint Tnil)) tint cc_default))
        ((Econst_int (Int.repr 1) tint) :: (Econst_int (Int.repr 2) tint) ::
         nil))
      (Scall None
        (Evar _add (Tfunction (Tcons tint (Tcons tint Tnil)) tint cc_default))
        ((Etempvar _t'1 tint) :: (Econst_int (Int.repr 5) tint) :: nil)))
...
(_main :: _add :: ___builtin_debug :: ___builtin_fmin :: ___builtin_fmax ::
