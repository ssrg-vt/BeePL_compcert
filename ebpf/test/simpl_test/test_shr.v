...
Module Info.
  ...
  Definition source_file := "ebpf/test/simpl_test/test_shr.c".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 84) :: Init_int8 (Int.repr 104) ::
                ...
                Init_int8 (Int.repr 48) :: Init_int8 (Int.repr 33) ::
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_val1, tlong) :: (_val2, tlong) :: (_result, tlong) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _val1 (Ecast (Econst_int (Int.repr 64) tint) tlong))
    (Ssequence
      (Sset _val2 (Ecast (Econst_int (Int.repr 32) tint) tlong))
      (Ssequence
        (Sset _result
          (Ebinop Oshr (Etempvar _val1 tlong) (Etempvar _val2 tlong) tlong))
        (Ssequence
          (Sbuiltin None (EF_annot 1%positive "The result should be 0" nil)
            Tnil nil)
          (Ssequence
            (Scall None
              (Evar _printf (Tfunction (Tcons (tptr tuchar) Tnil) tint
                              {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
              ((Evar ___stringlit_1 (tarray tuchar 19)) ::
               (Etempvar _result tlong) :: nil))
            (Ssequence
              (Sifthenelse (Ebinop Oeq (Etempvar _result tlong)
                             (Econst_int (Int.repr 0) tint) tint)
                (Scall None
                  (Evar _printf (Tfunction (Tcons (tptr tuchar) Tnil) tint
                                  {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                  ((Evar ___stringlit_3 (tarray tuchar 17)) :: nil))
                (Scall None
                  (Evar _printf (Tfunction (Tcons (tptr tuchar) Tnil) tint
                                  {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                  ((Evar ___stringlit_2 (tarray tuchar 21)) :: nil)))
...
(_main :: _printf :: ___builtin_debug :: ___builtin_expect ::
