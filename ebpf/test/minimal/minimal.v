...
Module Info.
  ...
  Definition arch := "ebpf".
  Definition model := "64".
  Definition abi := "standard".
  Definition bitsize := 64.
  Definition big_endian := false.
  Definition source_file := "ebpf/test/minimal/minimal.c".
  Definition normalized := true.
End Info.

Definition _LICENSE : ident := $"LICENSE".
Definition _____fmt : ident := $"____fmt".
Definition _____fmt__1 : ident := $"____fmt__1".
Definition _____fmt__2 : ident := $"____fmt__2".
...
Definition _bpf_trace_printk : ident := $"bpf_trace_printk".
Definition _ctx : ident := $"ctx".
Definition _handle_tp : ident := $"handle_tp".
Definition _main : ident := $"main".
Definition _my_pid : ident := $"my_pid".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 80) :: Init_int8 (Int.repr 114) ::
                ...
                Init_int8 (Int.repr 105) :: Init_int8 (Int.repr 110) ::
                Init_int8 (Int.repr 116) :: Init_int8 (Int.repr 102) ::
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 72) :: Init_int8 (Int.repr 101) ::
                ...
                Init_int8 (Int.repr 33) :: Init_int8 (Int.repr 0) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.

Definition v_bpf_trace_printk := {|
  gvar_info := (tptr (Tfunction (Tcons (tptr tuchar) (Tcons tuint Tnil))
                       tlong
                       {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}));
  gvar_init := (Init_int64 (Int64.repr 6) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.

Definition v_bpf_get_current_pid_tgid := {|
  gvar_info := (tptr (Tfunction Tnil tulong cc_default));
  gvar_init := (Init_int64 (Int64.repr 14) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_____fmt__2 := {|
  gvar_info := (tarray tuchar 23);
  gvar_init := (Init_int8 (Int.repr 66) :: Init_int8 (Int.repr 80) ::
...
Definition f_handle_tp := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_ctx, (tptr tvoid)) :: nil);
  fn_vars := nil;
  fn_temps := ((_my_pid, tlong) :: (_pid, tlong) :: (_t'1, tulong) ::
               (_t'5,
                (tptr (Tfunction (Tcons (tptr tuchar) (Tcons tuint Tnil))
                        tlong
                        {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))) ::
               (_t'4, (tptr (Tfunction Tnil tulong cc_default))) ::
               (_t'3,
                (tptr (Tfunction (Tcons (tptr tuchar) (Tcons tuint Tnil))
                        tlong
                        {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))) ::
  ...
  fn_body :=
(Ssequence
  (Sset _my_pid (Ecast (Econst_int (Int.repr 0) tint) tlong))
  (Ssequence
    (Scall None
      (Evar _printf (Tfunction (Tcons (tptr tuchar) Tnil) tint
                      {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
      ((Evar ___stringlit_1 (tarray tuchar 20)) :: nil))
    (Ssequence
      (Ssequence
        (Sset _t'5
          (Evar _bpf_trace_printk (tptr (Tfunction
                                          (Tcons (tptr tuchar)
                                            (Tcons tuint Tnil)) tlong
                                          {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))))
        (Scall None
          (Etempvar _t'5 (tptr (Tfunction
                                 ...
                                 tlong
                                 {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|})))
          ((Evar _____fmt (tarray tuchar 20)) ::
           (Esizeof (tarray tuchar 20) tulong) :: nil)))
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'4
              (Evar _bpf_get_current_pid_tgid (tptr (Tfunction Tnil tulong
                                                      cc_default))))
            (Scall (Some _t'1)
              (Etempvar _t'4 (tptr (Tfunction Tnil tulong cc_default))) nil))
          (Sset _pid
            (Ebinop Oshr (Ecast (Etempvar _t'1 tulong) tlong)
              (Ecast (Econst_int (Int.repr 32) tint) tlong) tlong)))
        (Ssequence
          (Sbuiltin None (EF_annot 1%positive "pid is evaulated to 0" nil)
            Tnil nil)
          (Ssequence
            (Sifthenelse (Ebinop Oeq (Etempvar _pid tlong)
                           (Etempvar _my_pid tlong) tint)
              (Ssequence
                (Sset _t'3
                  (Evar _bpf_trace_printk (tptr (Tfunction
                                                  (Tcons (tptr tuchar)
                ...
                (Scall None
                  (Etempvar _t'3 (tptr (Tfunction
                                         (Tcons (tptr tuchar)
                                           (Tcons tuint Tnil)) tlong
                                         {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|})))
                  ((Evar _____fmt__1 (tarray tuchar 22)) ::
                   (Esizeof (tarray tuchar 22) tulong) :: nil)))
              (Sreturn (Some (Econst_int (Int.repr 0) tint))))
            (Ssequence
              (Scall None
                (Evar _printf (Tfunction (Tcons (tptr tuchar) Tnil) tint
                                {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                ((Evar ___stringlit_2 (tarray tuchar 26)) ::
                 (Etempvar _pid tlong) :: nil))
              (Ssequence
                (Ssequence
                  (Sset _t'2
                    (Evar _bpf_trace_printk (tptr (Tfunction
                  ...
                  (Scall None
                    (Etempvar _t'2 (tptr (Tfunction
                                           (Tcons (tptr tuchar)
                                             (Tcons tuint Tnil)) tlong
                                           {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|})))
                    ((Evar _____fmt__2 (tarray tuchar 23)) ::
                     (Esizeof (tarray tuchar 23) tulong) :: nil)))
                (Sreturn (Some (Econst_int (Int.repr 0) tint)))))))))))
|}.
...
(Ssequence
  (Ssequence
    (Scall None
      (Evar _handle_tp (Tfunction (Tcons (tptr tvoid) Tnil) tint cc_default))
...
((___compcert_va_int32,
 ...
 (_printf,
   Gfun(External (EF_external "printf"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_bpf_trace_printk, Gvar v_bpf_trace_printk) ::
 (_bpf_get_current_pid_tgid, Gvar v_bpf_get_current_pid_tgid) ::
 (_LICENSE, Gvar v_LICENSE) :: (_____fmt, Gvar v_____fmt) ::
 (_____fmt__1, Gvar v_____fmt__1) :: (_____fmt__2, Gvar v_____fmt__2) ::
 (_handle_tp, Gfun(Internal f_handle_tp)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _handle_tp :: _LICENSE :: _printf :: ___builtin_debug ::
