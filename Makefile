...
BEEPL_TESTS=\
  ...
  BeePL_option_ex1.v BeePL_option_ex2.v BeePL_match_ex1.v BeePL_for_ex1.v BeePL_for_ex2.v BeePL_bpf_get_prandom.v
...
CFRONTEND=BeePL_mem.v BeePL_aux.v BeePL.v BeePL_auxlemmas.v BeePL_sem.v BeePL_typechecker.v BeePL_typesystem.v \
  BeePL_safety.v BeePL_typesystem_proofs.v BeePL_Check_Reserved_Struct.v BeePL_Option_Struct.v BeePL_Csyntax.v BeePL_compiler_proofs.v Ctypes.v Cop.v Csyntax.v Csem.v Ctyping.v Cstrategy.v Cexec.v \
