...
BEEPL_TESTS=\
  BeePL_progs.v BeePL_add.v BeePL_cond.v BeePL_app.v BeePL_div_zero.v BeePL_struct_ex1.v BeePL_struct_ex2.v BeePL_struct_ex3.v BeePL_struct_ex4.v BeePL_option_ex1.v BeePL_for_ex1.v BeePL_div_zero1.v BeePL_for_ex2.v
