...
| Ty_const : forall Gamma Sigma c t,
             type_expr Gamma Sigma c empty_effect t
| Ty_appr : forall Gamma Sigma r e es h bt rt ef efs ts, 
            get_ty Gamma r = Some rt ->
            type_expr Gamma Sigma (Var r rt) empty_effect rt -> 
            type_expr Gamma Sigma e ef (Reftype h bt) -> 
            type_exprs Gamma Sigma es efs ts -> 
            type_expr Gamma Sigma (App (Some r) e es rt) (ef ++ efs) rt
...
| Ty_loc : forall Gamma Sigma l h bt,
           get_sty Sigma l = Some bt ->
           type_expr Gamma Sigma (Addr l bt) empty_effect (Reftype h bt) 
