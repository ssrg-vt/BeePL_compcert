...
Definition tpstruct x := Ptrtype (Reftype mem_ident (bstruct x) noattr).
Definition toption t := Ptrtype (Otype t).
Definition toint8u := Ptrtype (Otype (Reftype mem_ident bint8u noattr)).
Definition toint8s := Ptrtype (Otype (Reftype mem_ident bint8s noattr)).
Definition toint16u := Ptrtype (Otype (Reftype mem_ident bint16u noattr)).
Definition toint16s := Ptrtype (Otype (Reftype mem_ident bint16s noattr)).
Definition toint32u := Ptrtype (Otype (Reftype mem_ident bint32u noattr)).
Definition toint32s := Ptrtype (Otype (Reftype mem_ident bint32s noattr)).
Definition tolongu := Ptrtype (Otype (Reftype mem_ident blongu noattr)).
Definition tolongs := Ptrtype (Otype (Reftype mem_ident blongs noattr)).
Definition tostruct s a := Ptrtype (Otype (Reftype mem_ident (bstruct s) a)).
Definition tpfun ts ef t := Ptrtype (Fptype ts ef t).
Definition tunit := Utype.
Definition tbarray t z a := Atype t z a.
Definition tparray t z a := Ptrtype (Reftype mem_ident (Barray t z a) noattr).
