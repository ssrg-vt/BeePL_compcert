...
Record bsignature := { bsig_args : list type; bsig_res : type; bsig_cc : calling_convention }. 
...
match f with 
| Internal f => type_of_function f ef
| External e ts t cc => Ftype ts ef t
end. 
...
| step_call : forall m f k C e es t l vs fd ef,
              leftcontext RV RV C ->
