...
| Mbind x t e e' t' => Ecomma (Eassign (Evar x (transBeePL_type t)) (transBeePL_expr_expr e) Tvoid) (transBeePL_expr_expr e') Tvoid
...
*)
Definition bpl := (Mbind x (BeeTypes.Ptype (BeeTypes.Tint)) (Const (ConsInt (Int.repr 2)) (BeeTypes.Ptype BeeTypes.Tint)) 
                    (Var x (BeeTypes.Ptype (BeeTypes.Tint))) (BeeTypes.Ptype BeeTypes.Tunit)). 

Compute (transBeePL_expr_st bpl). 
